...
Use a Feishu bot to talk to the **ChatGPT web session already logged in on your local browser**, then send ChatGPT's replies back to Feishu.

![Feishu ChatGPT conversation demo](./img/who-en.png)

It also supports multimodal workflows with images and files, including relaying files generated by ChatGPT back to Feishu.

![Multimodal file workflow demo](./img/files-en.png)
